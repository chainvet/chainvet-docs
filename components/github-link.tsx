...
/**
 * A labeled GitHub repo link for the sidebar footer — the icon plus
 * "chainvet/chainvet", instead of a bare icon with an empty gap.
 */
export function GithubSidebarLink() {
  return (
    <a
      ...
      className="flex items-center gap-2 text-sm text-fd-muted-foreground transition-colors hover:text-fd-foreground"
    >
      <svg
        viewBox="0 0 16 16"
        width="16"
