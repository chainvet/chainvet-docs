...
It's a thin language client that launches the [`chainvet-lsp`](/frontends/lsp)
...
The [AI features](/concepts/ai-features) are **off by default** — with them off,
...
[CLI](/cli/overview), or the [language server](/frontends/lsp) directly.
