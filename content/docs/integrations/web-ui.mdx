...
no bundler) that talks to a running [`chainvet-server`](/docs/frontends/server) over
...
- **Audit report download** — Markdown, HTML, or PDF of the most recent scan (the
  same Cyfrin-style [report](/docs/cli/audit-reports) the CLI produces). PDF requires
